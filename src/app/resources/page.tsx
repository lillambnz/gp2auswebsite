          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-orange-300 to-amber-400">
                UK GPs Moving to Australia
              </span>
            </h1>
            <p className="text-xl text-sky-200">
              Everything you need to prepare for Australian general practice.
            </p>
          </motion.div>
        </div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold text-white">GP Starter Resources</h2>
              </div>
              <p className="text-sky-300 leading-relaxed mb-4">
                Starting in Australian general practice is different to NHS work. From the MBS billing system to clinical guidelines and referral pathways, there&apos;s a lot to get familiar with before your first day.
              </p>
              <p className="text-sky-300 leading-relaxed">
                We provide registered GPs with a curated starter pack to ensure they&apos;re prepared and confident from day one.
              </p>
            </div>
            ...
            <Card className="bg-gradient-to-br from-[#082f4a] to-[#0c4a6e] border-amber-500/30">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">Full Resource Pack for Registered GPs</h3>
                </div>
                <p className="text-sky-300 mb-6">
                  Our complete GP Australia Starter Pack is available to registered GPs and includes everything you need to hit the ground running. Start with our free guide to get a taste.
                </p>
                <div className="grid sm:grid-cols-3 gap-3 mb-8">
                  {[
                    "Australian MBS billing guide",
                    "Medicare essentials",
                    "Clinical guideline differences",
                    "Referral pathway overview",
                    "Australian prescribing guide",
                    "First-week preparation pack",
                  ].map((item, i) => (
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-teal-700/30 rounded-xl p-6 border border-teal-500/30 flex flex-col justify-between">
                    <div>
                      <h4 className="font-semibold text-white mb-2">Get the full starter pack</h4>
                      <p className="text-sm text-teal-200 mb-4">
                        Register with us and receive the complete GP Australia Starter Pack — plus ongoing support from our team throughout your first year.
                      </p>
                    </div>
                    <Button
