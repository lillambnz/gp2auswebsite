        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <p className="text-xl text-sky-200">
              Understanding the financial side of your move.
            </p>
          </motion.div>
        </div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-semibold text-white">What Does It Cost?</h2>
              </div>
              <p className="text-sky-300 leading-relaxed mb-4">
                Relocating to Australia as a GP involves registration fees, visa costs, and moving expenses — but the investment is typically recovered within the first few months of practice given Australian GP earning levels.
              </p>
              <p className="text-sky-300 leading-relaxed">
                The exact costs vary significantly depending on your registration pathway, visa type, family size, and destination. Our detailed cost breakdown is available to registered GPs.
              </p>
            </div>
            ...
            <Card className="bg-gradient-to-br from-[#082f4a] to-[#0c4a6e] border-amber-500/30">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">Full Cost Breakdown in Our GP Guide</h3>
                </div>
                <p className="text-sky-300 mb-6">
                  Our full cost calculator — including registration fees, visa costs, relocation budgeting, and an earnings comparison — is available in the <strong className="text-amber-300">GP Australia Relocation Guide</strong>.
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-teal-700/30 rounded-xl p-6 border border-teal-500/30 flex flex-col justify-between">
                    <div>
                      <h4 className="font-semibold text-white mb-2">Talk to us about costs</h4>
                      <p className="text-sm text-teal-200 mb-4">
                        Register with us and we&apos;ll walk you through a personalised cost plan based on your specific pathway.
                      </p>
                    </div>
                    <Button
